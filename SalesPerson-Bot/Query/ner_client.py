...
if __name__ == "__main__":
	...
	ner = NerClient("1PI11CS013", "g16")

	#ret = ner.get_spec_fields()
	ret = ner.get_spec(brand = "Samsung", product = "E1195")
	#print ret
   ...
   #import sys
	...
	#ret = ner.get_spec_fields()
	#print ret
	'''fn = r"C:\Users\aditya\Desktop\Day3\Query\mymaxent1.py"
	ret = ner.upload(fn) # web service for upload
	print ret'''
	fn = r"C:\Users\aditya\Desktop\Day3\Query\build_history1.py"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\build_history.py"
	ret = ner.upload(fn) # web service for upload
	print ret
'''	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\query_input1.py"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\templateGenerate.py"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\MyMaxEnt.py"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\feature_functions.py"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\history.p"
	ret = ner.upload(fn) # web service for upload
	print ret
	fn = r"C:\Users\aditya\Desktop\Day3\Query\all_data.p"
	ret = ner.upload(fn) # web service for upload
	print ret
'''
