...
if(1):
 #----- REPLACE THESE PATHS FOR YOUR SYSTEM ---------------------
	json_file = r"C:\Users\aditya\Desktop\Day3\Query\all_data.json"
	#pickle_file = r"C:\home\ananth\research\pesit\nlp\ner\all_data.p"
	pickle_file = r"C:\Users\aditya\Desktop\Day3\Query\all_data.p"
	history_file = r"C:\Users\aditya\Desktop\Day3\Query\history.p"
	model_metrics_file = r"C:\Users\aditya\Desktop\Day3\Query\model_metrics.p"
	# ----------------------------------------------------------------
	...
	func_obj = FeatureFunctions(sents, supported_tags, ret) #FeatureFunctions(supported_tags)
